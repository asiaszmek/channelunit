...
NEURON {
    ...
    RANGE gion                           
    RANGE gbar                              : Will be changed when ion channel mechanism placed on cell!
...
PARAMETER {
    ...
    gbar = 0  (S/cm2)                       : Will be changed when ion channel mechanism placed on cell!
    gmin = 0  (S/cm2)
